	...
	private:
		...
		static double LookupProbability(double chiSquare) {
			auto chiSquareTable = std::initializer_list<std::pair<double, double>> {
				// df = 15
				{ 37.697, 1 - 0.001 }, { 35.628, 1 - 0.002 }, { 32.801, 1 - 0.005 }, { 30.578, 1 - 0.010 }, { 27.488, 1 - 0.025 },
				{ 24.996, 1 - 0.050 }, { 22.307, 1 - 0.100 }, { 18.245, 1 - 0.250 }, { 14.339, 1 - 0.500 }, { 11.037, 1 - 0.750 },
				{ 8.5470, 1 - 0.900 }, { 7.2610, 1 - 0.950 }, { 6.2620, 1 - 0.975 }, { 5.2290, 1 - 0.990 }, { 4.6010, 1 - 0.995 }
			};
