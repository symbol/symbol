...
namespace test {
	...
	private:
		static Checker CreateCheckerForCanCreatePuppyTreeWithRootBranchNode(const DataSource& dataSource) {
			...
			// tree 1
			auto verbPuppyCoinBranchHash = checker.addBranch({ 0x14, 0x6F }, { { 0, verbHash }, { 6, puppyCoinBranchHash } }, "verb-puppy-coin");
	...
	private:
		static Checker CreateCheckerForCanCreatePuppyTreeWithRootExtensionNode(const DataSource& dataSource) {
			...
			// tree 1
			auto verbPuppyCoinBranchHash = checker.addBranch({ 0x00, 0x6F }, { { 0, verbHash }, { 6, puppyCoinBranchHash } }, "verb-puppy-coin");
