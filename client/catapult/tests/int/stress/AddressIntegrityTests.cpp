...
#define TEST_CLASS AddressIntegrityTests
	...
	namespace {
		struct MijinTestNetworkTraits {
			...
			static constexpr auto Expected_Nemesis_Address = "SARNAMOK7M4ZHNL75ZNNYC6UAM5EGH57UEAQX5I4";
			...
			static std::vector<std::string> ExpectedAddresses() {
				return {
					"SAAA26Z5QXYHDIVO2EYSEF7BUMC7FYQPBQSPHQ5O",
					"SAAA3ZE57CKRZY762QG4OG3RMM2EEAN6SLZ6KDSL",
					"SAAA4RUOJ2RBEKWYOZHSMZWTDGHMCRDUCNAKNFD2",
					"SAAA6NI72BJ4FEE24JNVTSQRZHXGZCZCJ6NGNTZ5",
					"SAAA7O53WQULXNOK2GTP7QURX7RKPRDNF5UMC4NO",
					"SAAAC7XL2E6XC2NCSXI4C6MG7HWZGE47WHNIQG47",
					"SAAADPWJ27OZVPSPMWCX5QQWWC47IF6KUFQTWC22",
					"SAAAEBW5QTJAYLWOYUZDJO7BJIZCIFRP3H25Y5CF",
					"SAAAFAXT2EHGLAOXOR6I3JXR27ED7Q3LEHIVPM2L",
					"SAAAG6WJ6IHREIOJN4U5H6GV5HAQLWU7SMEVWFVO",
					"SAAAHTKTAW4NLGLXU7U2ZWP5LWQ4Y7DGYWNGKXVV"
				};
			}
		};
