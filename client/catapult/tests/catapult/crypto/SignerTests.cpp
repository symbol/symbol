...
#define VERIFY_MULTI_TEST(TEST_NAME)                                              \
    ...
    {                                                                             \
        TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<VerifyMultiTraits>();             \
    }                                                                             \
    TEST(TEST_CLASS, TEST_NAME##_ShortCircuit)                                    \
    {                                                                             \
        TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<VerifyMultiShortCircuitTraits>(); \
    }                                                                             \
    template <typename TTraits>                                                   \
    void TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)()
    ...
    {
        AssertSignedPayloadsCannotBeVerifiedAsBatches<TTraits>(
            [](auto& signatureInputs, auto index) { const_cast<Key&>(signatureInputs[index].PublicKey) = Valid_Public_Key; });
    }

    VERIFY_MULTI_TEST(SignedPayloadsCannotBeVerifiedAsBatches_DifferentRPart)
    {
        AssertSignedPayloadsCannotBeVerifiedAsBatches<TTraits>(
            [](auto& signatureInputs, auto index) { const_cast<Signature&>(signatureInputs[index].Signature)[5] ^= 0xFF; });
    }

    VERIFY_MULTI_TEST(SignedPayloadsCannotBeVerifiedAsBatches_DifferentSPart)
    {
        AssertSignedPayloadsCannotBeVerifiedAsBatches<TTraits>(
            [](auto& signatureInputs, auto index) { const_cast<Signature&>(signatureInputs[index].Signature)[47] ^= 0xFF; });
    }

    VERIFY_MULTI_TEST(SignedPayloadsCannotBeVerifiedAsBatches_DifferentPayload)
    {
        AssertSignedPayloadsCannotBeVerifiedAsBatches<TTraits>(
            [](auto& signatureInputs, auto index) { const_cast<uint8_t*>(signatureInputs[index].Buffers[0].pData)[13] ^= 0xFF; });
    }
    ...
    {
        AssertSignedPayloadsCannotBeVerifiedAsBatches<TTraits>(
            [](auto& signatureInputs, auto index) { const_cast<Key&>(signatureInputs[index].PublicKey) = Key(); });
    }
    ...
    namespace {
        ...
        TestVectorsInput GetTestVectorsInput()
        {
            ...
            input.PrivateKeys = { "9D61B19DEFFD5A60BA844AF492EC2CC44449C5697B326919703BAC031CAE7F60",
                "4CCD089B28FF96DA9DB6C346EC114E0F5B8A319F35ABA624DA8CF6ED4FB8A6FB",
                "C5AA8DF43F9F837BEDB7442F31DCB7B166D38535076F094B85CE3A2E0B4458F7",
                "F5E5767CF153319517630F226876B86C8160CC583BC013744C6BF255F5CC0EE5",
                "833FE62409237B9D62EC77587520911E9A759CEC1D19755B7DA901B96DCA3D42" };
            input.ExpectedPublicKeys = { "D75A980182B10AB7D54BFED3C964073A0EE172F3DAA62325AF021A68F707511A",
                "3D4017C3E843895A92B70AA74D1B7EBC9C982CCF2EC4968CC0CD55F12AF4660C",
                "FC51CD8E6218A1A38DA47ED00230F0580816ED13BA3303AC5DEB911548908025",
                "278117FC144C72340F67D0F2316E8386CEFFBF2B2428C9C51FEF7C597F1D426E",
                "EC172B93AD5E563BF4932C70E1245034C35467EF2EFD4D64EBF819683467E2BF" };
            input.ExpectedSignatures = { "E5564300C360AC729086E2CC806E828A84877F1EB8E5D974D873E06522490155"
