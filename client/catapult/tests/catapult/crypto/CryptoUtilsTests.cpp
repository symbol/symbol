...
#define TEST_CLASS CryptoUtilsTests
	...
	namespace {
		...
		std::vector<std::string> GenerateNonceSamplesOutput() {
			return { "E5564300C360AC729086E2CC806E828A84877F1EB8E5D974D873E06522490155",
	...
	namespace {
		...
		std::vector<ScalarMultTestVectorsInput> ScalarMultSamplesInput() {
			return { { "4F91BE9568552181E01968999EFC09BFEB77A736B8F3188160B7769D7B9B9F6E",
		...
		std::vector<std::string> ScalarMultSamplesOutput() {
			return { "0E4FE00C66999D8D4E8855AABA89A11ED887BECA44580612EF99246E84C56F97",
