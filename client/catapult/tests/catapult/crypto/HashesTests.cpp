	...
	namespace {
		...
		struct Ripemd160_Traits {
			...
			static std::vector<std::string> SampleTestVectorsOutput() {
				return { "0BDC9D2D256B3EE9DAAE347BE6F4DC835A467FFE", "8EB208F7E05D987A9B044A8E98C6B087F15A0BFC",
					"5D0689EF49D2FAE572B881B123A85FFA21595F36", "F71C27109C692C1B56BBDCEB5B9D2865B3708DBC",
					"12A053384A9C0C88E405A06C27DCF49ADA62EB2B", "B0E20B6E3116640286ED3A87A5713079B21F5189",
		...
		struct Bitcoin160_Traits {
			...
			static std::vector<std::string> SampleTestVectorsOutput() {
				return { "994355199E516FF76C4FA4AAB39337B9D84CF12B",
		...
		struct Sha256Double_Traits {
			...
			static std::vector<std::string> SampleTestVectorsOutput() {
				return { "4F8B42C22DD3729B519BA6F68D2DA7CC5B2D606D05DAED5AD5128CC03E6C6358",
		...
		struct Sha512_Traits {
			...
			static std::vector<std::string> SampleTestVectorsOutput() {
				return { "1F40FC92DA241694750979EE6CF582F2D5D7D28E18335DE05ABC54D0560E0F53"
			...
			static std::string MillionTimesATestVector() {
				return "E718483D0CE769644E2E42C7BC15B4638E1F98B13B2044285632A803AFA973EB"
		...
		struct Keccak_Base {
			...
			static std::vector<std::string> SampleTestVectorsInput() {
				return { "CC", "41FB", "1F877C", "C1ECFDFC", "9F2FCC7C90DE090D6B87CD7E9718C1EA6CB21118FC2D5DE9F97E5DB6AC1E9C10" };
			}
		};
		...
		struct Sha3_256_Traits : public Keccak_Base {
			...
			// data from: http://mumble.net/~campbell/hg/sha3/kat/ShortMsgKAT_SHA3-256.txt
			static std::vector<std::string> SampleTestVectorsOutput() {
				return { "677035391CD3701293D385F037BA32796252BB7CE180B00B582DD9B20AAAD7F0",
...
#define MAKE_HASH_TEST(TRAITS_PREFIX, TEST_NAME)     \
	TEST(TEST_CLASS, TRAITS_PREFIX##_##TEST_NAME) {  \
		Assert##TEST_NAME<TRAITS_PREFIX##_Traits>(); \
	}
...
#define SHA3_TRAITS_BASED_TEST(TEST_NAME)                                 \
	...
	TEST(TEST_CLASS, Sha3_256_##TEST_NAME) {                              \
		TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<Sha3_256_Traits>();       \
	}                                                                     \
	TEST(TEST_CLASS, GenerationHash_##TEST_NAME) {                        \
		TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<GenerationHash_Traits>(); \
	}                                                                     \
	template <typename TTraits>                                           \
	void TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)()
	...
	namespace {
		...
		public:
			...
			static std::vector<std::string> SampleTestVectorsOutput() {
				return { "A21B1F5D4CF4F73A4DD939750F7A066A7F98CC131CB16A6692759021CFAB8181",
		...
		public:
			static std::vector<std::string> SampleTestVectorsKey() {
				return { "0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B",
					"4A656665",
			...
			static std::vector<std::string> SampleTestVectorsOutput() {
				return { "87AA7CDEA5EF619D4FF0B4241A1D6CB02379F4E2CE4EC2787AD0B30545E17CDE"
	...
	namespace {
		...
		const char* Data_Sets_Long[] = { "9F2FCC7C90DE090D6B87CD7E9718C1EA6CB21118FC2D5DE9F97E5DB6AC1E9C10",
		...
		void AssertConcatenatedHashMatchesSingleCallVariant(TCalculateHashSingle calculateHashSingle) {
			...
			for (const auto& dataStr : Data_Sets_Long) {
				...
				OutputHashType result1;
				{
					...
					hashBuilder.update({ { buffer.data(), splitInTwo }, { buffer.data() + splitInTwo, buffer.size() - splitInTwo } });
				...
				{
					THashBuilder hashBuilder;
					hashBuilder.update({ { buffer.data(), splitInThree },
				...
				{
					THashBuilder hashBuilder;
					hashBuilder.update({ { buffer.data(), splitInFour },
