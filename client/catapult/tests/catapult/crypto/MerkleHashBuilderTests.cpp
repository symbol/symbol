	...
	namespace {
		...
		struct MerkleHashTraits {
			...
			static const ResultType DeterministicResultBalanced() {
				...
				return test::ToArray<Hash256_Size>("454EF245CE568DA6A1C2D0B14FF3AEA09EC5CB0E76F356A4118F220E01B4BB8D");
#else
				return test::ToArray<Hash256_Size>("7D853079F5F9EE30BDAE49C4956AF20CDF989647AFE971C069AC263DA1FFDF7E");
#endif
			}

			static const ResultType DeterministicResultUnbalanced() {
#ifdef SIGNATURE_SCHEME_NIS1
				return test::ToArray<Hash256_Size>("B526B3459648D92D0570646D13FF39C8B18EEA926BD2F97A0B19A6401D600671");
#else
				return test::ToArray<Hash256_Size>("DEFB4BF7ACF2145500087A02C88F8D1FCF27B8DEF4E0FDABE09413D87A3F0D09");
#endif
			}
		...
		struct MerkleTreeTraits {
			...
			static const ResultType DeterministicResultBalanced() {
				...
				return {
					...
					test::ToArray<Hash256_Size>("9AFFB3AE2D43B6FB7C82238DAB15C478BD004FEB1239F3C7562B67D92B091198"),
					test::ToArray<Hash256_Size>("47CAAA7305ECB42C3F079987D88E58C573DD8671375431ADA9A7183FCC774766"),
					test::ToArray<Hash256_Size>("61EC0E9EB1E5DAD46DE7F6D29D0A470E9EDEEB7BBCDA6275BFCA44BFAB4A7778"),
					test::ToArray<Hash256_Size>("A7A8DC21DF463B2D589FF792FD89A900A4412E00719080A85E859CA33D96B186"),
					test::ToArray<Hash256_Size>("7B8940AEF5FAD1FF56CA663A29F18291F279C8D2850FA21932E2C229D35D2ED3"),
					test::ToArray<Hash256_Size>("525F6C8EC232424CB041DDAF03F871B9C85479122554657B2B16408A4D1FCA97"),
					test::ToArray<Hash256_Size>("454EF245CE568DA6A1C2D0B14FF3AEA09EC5CB0E76F356A4118F220E01B4BB8D")
				};
#else
				return {
					test::ToArray<Hash256_Size>("36C8213162CDBC78767CF43D4E06DDBE0D3367B6CEAEAEB577A50E2052441BC8"),
					...
					test::ToArray<Hash256_Size>("1E6516B2CC617E919FAE0CF8472BEB2BFF598F19C7A7A7DC260BC6715382822C"),
					test::ToArray<Hash256_Size>("410330530D04A277A7C96C1E4F34184FDEB0FFDA63563EFD796C404D7A6E5A20"),
					test::ToArray<Hash256_Size>("5C3BF2D64B151451DB3189EA569CC3BCB022E62D2C3C9FCC88B4683C6B550849"),
					test::ToArray<Hash256_Size>("4B5B85209A686C423A278EE0B553375C247C479221DB041392D2876CBE167A43"),
					test::ToArray<Hash256_Size>("135C564CAD34FF27C98CBC07FCBD13591596B9EB08B41B2C4B29FB137CBFBE84"),
					test::ToArray<Hash256_Size>("62A067A76E7806772E2EA59AD61B8E3F15156698B7A1A6457709204D5E2EF356"),
					test::ToArray<Hash256_Size>("3C8C43FB0425AB4E458363560703044BEF01A2F84D28B42A6BA60AFAA2F0A15D"),
					test::ToArray<Hash256_Size>("35610FA7E92A198913975952443DD198A8FFADF0BB3D780BBE29E82EA0B1C22F"),
					test::ToArray<Hash256_Size>("7D853079F5F9EE30BDAE49C4956AF20CDF989647AFE971C069AC263DA1FFDF7E")
				};
#endif
			}
			...
			static const ResultType DeterministicResultUnbalanced() {
				...
				return {
					...
					test::ToArray<Hash256_Size>("9AFFB3AE2D43B6FB7C82238DAB15C478BD004FEB1239F3C7562B67D92B091198"),
					test::ToArray<Hash256_Size>("47CAAA7305ECB42C3F079987D88E58C573DD8671375431ADA9A7183FCC774766"),
					test::ToArray<Hash256_Size>("E1C7661E79114AE3FD935A83F02E5BAE10EC7B50D45BC146A7FB1768F2467362"),
					test::ToArray<Hash256_Size>("E1C7661E79114AE3FD935A83F02E5BAE10EC7B50D45BC146A7FB1768F2467362"),
					test::ToArray<Hash256_Size>("7B8940AEF5FAD1FF56CA663A29F18291F279C8D2850FA21932E2C229D35D2ED3"),
					test::ToArray<Hash256_Size>("AB8F6EFA459A6AA5EB76BE5312F208224FB98E114F0E54BE6F23CE69B2167035"),
					test::ToArray<Hash256_Size>("B526B3459648D92D0570646D13FF39C8B18EEA926BD2F97A0B19A6401D600671")
				};
#else
				return {
					test::ToArray<Hash256_Size>("36C8213162CDBC78767CF43D4E06DDBE0D3367B6CEAEAEB577A50E2052441BC8"),
					...
					test::ToArray<Hash256_Size>("5C3BF2D64B151451DB3189EA569CC3BCB022E62D2C3C9FCC88B4683C6B550849"),
					test::ToArray<Hash256_Size>("4B5B85209A686C423A278EE0B553375C247C479221DB041392D2876CBE167A43"),
					test::ToArray<Hash256_Size>("5E0595BF035076842751B01D06C7F139FA0A190C9ACFB582A25B449A62522E34"),
					test::ToArray<Hash256_Size>("5E0595BF035076842751B01D06C7F139FA0A190C9ACFB582A25B449A62522E34"),
					test::ToArray<Hash256_Size>("3C8C43FB0425AB4E458363560703044BEF01A2F84D28B42A6BA60AFAA2F0A15D"),
					test::ToArray<Hash256_Size>("D27767C5F49035071EBE402A495D0152E5B9307C86AF43BBE6FE3D35D41F245F"),
					test::ToArray<Hash256_Size>("DEFB4BF7ACF2145500087A02C88F8D1FCF27B8DEF4E0FDABE09413D87A3F0D09")
				};
#endif
			}
