	...
	namespace {
		...
		struct MerkleHashTraits {
			...
			static const ResultType DeterministicResultBalanced() {
				return test::ToArray<Hash256::Size>("7D853079F5F9EE30BDAE49C4956AF20CDF989647AFE971C069AC263DA1FFDF7E");
			}

			static const ResultType DeterministicResultUnbalanced() {
				return test::ToArray<Hash256::Size>("DEFB4BF7ACF2145500087A02C88F8D1FCF27B8DEF4E0FDABE09413D87A3F0D09");
			}
		...
		struct MerkleTreeTraits {
			...
			static const ResultType DeterministicResultBalanced() {
				return {
					...
					test::ToArray<Hash256::Size>("7A1711AF5C402CFEFF87F6DA4B9C738100A7AC3EDAD38D698DF36CA3FE883480"),
					test::ToArray<Hash256::Size>("1E6516B2CC617E919FAE0CF8472BEB2BFF598F19C7A7A7DC260BC6715382822C"),
					test::ToArray<Hash256::Size>("410330530D04A277A7C96C1E4F34184FDEB0FFDA63563EFD796C404D7A6E5A20"),
					test::ToArray<Hash256::Size>("5C3BF2D64B151451DB3189EA569CC3BCB022E62D2C3C9FCC88B4683C6B550849"),
					test::ToArray<Hash256::Size>("4B5B85209A686C423A278EE0B553375C247C479221DB041392D2876CBE167A43"),
					test::ToArray<Hash256::Size>("135C564CAD34FF27C98CBC07FCBD13591596B9EB08B41B2C4B29FB137CBFBE84"),
					test::ToArray<Hash256::Size>("62A067A76E7806772E2EA59AD61B8E3F15156698B7A1A6457709204D5E2EF356"),
					test::ToArray<Hash256::Size>("3C8C43FB0425AB4E458363560703044BEF01A2F84D28B42A6BA60AFAA2F0A15D"),
					test::ToArray<Hash256::Size>("35610FA7E92A198913975952443DD198A8FFADF0BB3D780BBE29E82EA0B1C22F"),
					test::ToArray<Hash256::Size>("7D853079F5F9EE30BDAE49C4956AF20CDF989647AFE971C069AC263DA1FFDF7E")
				};
			}
			...
			static const ResultType DeterministicResultUnbalanced() {
				return {
					...
					test::ToArray<Hash256::Size>("5C3BF2D64B151451DB3189EA569CC3BCB022E62D2C3C9FCC88B4683C6B550849"),
					test::ToArray<Hash256::Size>("4B5B85209A686C423A278EE0B553375C247C479221DB041392D2876CBE167A43"),
					test::ToArray<Hash256::Size>("5E0595BF035076842751B01D06C7F139FA0A190C9ACFB582A25B449A62522E34"),
					test::ToArray<Hash256::Size>("5E0595BF035076842751B01D06C7F139FA0A190C9ACFB582A25B449A62522E34"),
					test::ToArray<Hash256::Size>("3C8C43FB0425AB4E458363560703044BEF01A2F84D28B42A6BA60AFAA2F0A15D"),
					test::ToArray<Hash256::Size>("D27767C5F49035071EBE402A495D0152E5B9307C86AF43BBE6FE3D35D41F245F"),
					test::ToArray<Hash256::Size>("DEFB4BF7ACF2145500087A02C88F8D1FCF27B8DEF4E0FDABE09413D87A3F0D09")
				};
			}
