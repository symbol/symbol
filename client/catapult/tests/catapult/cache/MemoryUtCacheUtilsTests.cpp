...
#define GET_FIRST_TRAITS_BASED_TEST(TEST_NAME) \
	...
	GET_FIRST_TRAITS_BASED_TEST(GetFirstTransactionInfoPointersReturnsNoTransactionInfosIfCacheIsEmpty) {
		// Assert:
		RunGetFirstTest<TTraits>(0, 3, 0);
	}

	GET_FIRST_TRAITS_BASED_TEST(GetFirstTransactionInfoPointersReturnsNoTransactionInfosIfZeroAreRequested) {
		// Assert:
		RunGetFirstTest<TTraits>(10, 0, 0);
	}

	GET_FIRST_TRAITS_BASED_TEST(GetFirstTransactionInfoPointersReturnsFirstCountTransactionInfosIfCacheHasEnoughTransactions) {
		// Assert:
		RunGetFirstTest<TTraits>(10, 3, 3);
	}

	GET_FIRST_TRAITS_BASED_TEST(GetFirstTransactionInfoPointersReturnsAllTransactionInfosIfCacheHasExactlyRequestedTransactions) {
		// Assert:
		RunGetFirstTest<TTraits>(10, 10, 10);
	}

	GET_FIRST_TRAITS_BASED_TEST(GetFirstTransactionInfoPointersReturnsAllTransactionInfosIfCacheHasLessThanRequestedTransactions) {
		// Assert:
