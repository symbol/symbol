...
#define TEST_CLASS SubCachePluginAdapterTests
    ...
    namespace {
        ...
        using SimpleCachePluginAdapter = SimpleCachePluginAdapterT<test::SimpleCacheDefaultViewExtension, test::SimpleCacheDefaultDeltaExtension>;
        ...
        void AssertConstSubCacheView(const SubCacheView& view, size_t expectedValue, SubCacheViewType expectedViewType)
        {
            ...
            using ReadOnlyViewType = test::SimpleCacheReadOnlyType<test::SimpleCacheDefaultViewExtension, test::SimpleCacheDefaultDeltaExtension>;
