...
#pragma pack(pop)
	...
	namespace {
		...
		void AssertCanCreateBlockStatementWithSingleResolutionStatement() {
			...
			// Assert:
			auto resolutionStatementHash = CalculateResolutionStatementHash<TTraits>(unresolved, { { { 12, 11 }, resolved1 }, { { 14, 2 }, resolved2 } });
		...
		void AssertCanCreateBlockStatementWithMultipleResolutionStatements() {
			...
			// Assert:
			auto resolutionStatementHash1 = CalculateResolutionStatementHash<TTraits>(unresolved1, { { { 12, 11 }, resolved1 }, { { 14, 2 }, resolved3 } });
	...
	TEST(TEST_CLASS, CanCreateBlockStatementWithHeterogenousComponentStatements) {
		...
		auto addressResolutionStatementHash2 = CalculateResolutionStatementHash<AddressResolutionTraits>(unresolvedAddress2, { { { 12, 11 }, resolvedAddress2 } });
		...
		auto mosaicResolutionStatementHash2 = CalculateResolutionStatementHash<MosaicResolutionTraits>(unresolvedMosaicId2, { { { 14, 1 }, resolvedMosaicId2 } });
	...
	TEST(TEST_CLASS, CanCreateBlockStatementWithHeterogenousComponentStatementsAfterPoppingSource) {
		...
		auto addressResolutionStatementHash1 = CalculateResolutionStatementHash<AddressResolutionTraits>(unresolvedAddress1, { { { 12, 11 }, resolvedAddress1 } });
		auto addressResolutionStatementHash2 = CalculateResolutionStatementHash<AddressResolutionTraits>(unresolvedAddress2, { { { 12, 11 }, resolvedAddress2 } });

		auto mosaicResolutionStatementHash1 = CalculateResolutionStatementHash<MosaicResolutionTraits>(unresolvedMosaicId1, { { { 12, 11 }, resolvedMosaicId3 } });
