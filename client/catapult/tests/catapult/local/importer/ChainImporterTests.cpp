...
#define TEST_CLASS ChainImporterTests
    ...
    namespace {
        enum class SubscriberMode { None,
            Block_Change,
            State_Change,
            Finalization };
        enum class CacheDatabaseMode { Enabled,
            Disabled };
...
#pragma pack(pop)
        ...
        public:
            ...
            {
                auto supplementalFileStream = io::FileStream(io::RawFile(m_dataDirectory.dir("state").file("supplemental.dat"), io::OpenMode::Read_Only));
