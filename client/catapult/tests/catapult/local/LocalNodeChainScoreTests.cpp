...
namespace catapult { namespace local {
	...
	TEST(LocalNodeChainScoreTests, CanCreateDefaultChainScore) {
		// Act:
	...
	TEST(LocalNodeChainScoreTests, CanCreateChainScoreFromModelChainScore) {
		// Act:
	...
	TEST(LocalNodeChainScoreTests, CanAddToChainScore) {
		// Arrange:
