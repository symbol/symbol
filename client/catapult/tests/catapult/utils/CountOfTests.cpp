...
#define TRAIT_BASED_TEST(TEST_NAME) \
	...
	TEST(TEST_CLASS, TEST_NAME##_Primitive) { \
		TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<PrimitiveTraits>(); \
	} \
	TEST(TEST_CLASS, TEST_NAME##_Packed) { \
		TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<PackedTraits>(); \
	} \
	TEST(TEST_CLASS, TEST_NAME##_NonPacked) { \
		TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<NonPackedTraits>(); \
	} \
	template<typename TTraits> \
	void TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)()
