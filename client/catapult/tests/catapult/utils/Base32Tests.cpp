...
#define TEST_CLASS Base32Tests
	...
	namespace {
		const char* Decoded_Set[] = { "68BA9E8D1AA4502E1F73DA19784B5D7DA16CA1E4AF895FAC12",
		...
		const char* Encoded_Set[] = { "NC5J5DI2URIC4H3T3IMXQS25PWQWZIPEV6EV7LAS",
	...
	TEST(TEST_CLASS, EncodeAcceptsAllByteValues) {
		...
		// Assert:
		std::string expected = "AAAQEAYEAUDAOCAJBIFQYDIOB4IBCEQTCQKRMFYY"
	...
	TEST(TEST_CLASS, RoundtripStartingFromEncodedDoesNotChangeAnything) {
		std::string encodedForRoundtrip[]{ "BDS73DQ5NC33MKYI3K6GXLJ53C2HJ35A", "46FNYP7T4DD3SWAO6C4NX62FJI5CBA26" };
	...
	TEST(TEST_CLASS, RoundtripStartingFromDecodedDoesNotChangeAnything) {
		// Arrange:
		std::string decodedForRoundtrip[]{ "8A4E7DF5B61CC0F97ED572A95F6ACA", "2D96E4ABB65F0AD3C29FEA48C132CE" };
