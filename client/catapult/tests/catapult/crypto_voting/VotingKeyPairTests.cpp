...
#define TEST_CLASS VotingKeyPairTests
    ...
    TEST(TEST_CLASS, KeyPairPassesNemTestVectors)
    {
        ...
        std::string dataSet[] { "ED4C70D78104EB11BCD73EBDC512FEBC8FBCEB36A370C957FF7E266230BB5D57",
        ...
        std::string expectedSet[] { "5112BA143B78132AF616AF1A94E911EAD890FDB51B164A1B57C352ECD9CA1894",
