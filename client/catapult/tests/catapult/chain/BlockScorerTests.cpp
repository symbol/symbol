...
#define TEST_CLASS BlockScorerTests
	...
	TEST(TEST_CLASS, CanCalculateHit) {
		// Arrange:
		const GenerationHash generationHash{ { 0xF7, 0xF6, 0xF5, 0xF4, 0xF3, 0xF2, 0xF1, 0xF0, 0xE7, 0xE6, 0xE5,
											   0xE4, 0xE3, 0xE2, 0xE1, 0xE0, 0xD7, 0xD6, 0xD5, 0xD4, 0xD3, 0xD2,
											   0xD1, 0xD0, 0xC7, 0xC6, 0xC5, 0xC4, 0xC3, 0xC2, 0xC1, 0xC0 } };
	...
	TEST(TEST_CLASS, CanCalculateHitWhenGenerationHashIsMax) {
		// Arrange:
		const GenerationHash generationHash{ { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	...
	TEST(TEST_CLASS, BlockHitPredicateReturnsFalseWhenHitIsEqualToTarget_Context) {
		// Arrange:
		BlockHitContext hitContext;
		hitContext.GenerationHash = { { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
