...
namespace catapult { namespace chain {
	...
	TEST(UnlockedAccountsTests, InitiallyContainerIsEmpty) {
		// Arrange:
	...
	TEST(UnlockedAccountsTests, CanAddHarvestingEligibleAccount) {
		// Arrange:
	...
	TEST(UnlockedAccountsTests, AdditionOfAlreadyAddedAccountHasNoEffect) {
		// Arrange:
	...
	TEST(UnlockedAccountsTests, CanAddMultipleAccountsToContainer) {
		// Arrange:
	...
	TEST(UnlockedAccountsTests, CanRemoveAccountFromContainer) {
		// Arrange:
		auto keyPairWrapper1 = GenerateKeyPairWrapper();
		auto keyPairWrapper2 = GenerateKeyPairWrapper();
		TestContext context(8);
	...
	TEST(UnlockedAccountsTests, RemovalOfAccountNotInContainerHasNoEffect) {
		// Arrange:
		auto keyPairWrapper = GenerateKeyPairWrapper();
		TestContext context(8);
		auto& accounts = context.Accounts;
	...
	TEST(UnlockedAccountsTests, CanIterateOverAllAccounts) {
		// Arrange:
		TestContext context(8);
		const auto& accounts = context.Accounts;
	...
	TEST(UnlockedAccountsTests, RemovedAccountsAreNotIterated) {
		// Arrange:
		TestContext context(8);
		auto& accounts = context.Accounts;
	...
	TEST(UnlockedAccountsTests, CanAddMaxAccounts) {
		// Arrange:
		TestContext context(8);
		const auto& accounts = context.Accounts;
	...
	TEST(UnlockedAccountsTests, CannotAddMoreThanMaxAccounts) {
		// Arrange:
		TestContext context(8);
		const auto& accounts = context.Accounts;
	...
	TEST(UnlockedAccountsTests, RemovedAccountsDoNotCountTowardsLimit) {
		// Arrange:
		auto keyPairWrapper = GenerateKeyPairWrapper();
		TestContext context(8);
		auto& accounts = context.Accounts;
	...
	TEST(UnlockedAccountsTests, RemoveIfRemovesAllAccountsIfPredicateReturnsTrueForAllAccounts) {
		// Arrange:
		TestContext context(8);
		auto& accounts = context.Accounts;
	...
	TEST(UnlockedAccountsTests, RemoveIfRemovesNoAccountsIfPredicateReturnsFalseForAllAccounts) {
		// Arrange:
		TestContext context(8);
		auto& accounts = context.Accounts;
		for (auto i = 0u; i < 3u; ++i)
	...
	TEST(UnlockedAccountsTests, RemoveIfOnlyRemovesAccountsForWhichPredicateReturnsTrue) {
		// Arrange:
		TestContext context(8);
		auto& accounts = context.Accounts;
	...
	DEFINE_LOCK_PROVIDER_TESTS(UnlockedAccountsTests)
