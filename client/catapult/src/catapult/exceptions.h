...
namespace catapult {
	...
	public:
		...
		catapult_error(const catapult_error& rhs) : TStlException(rhs.what()), boost::exception(rhs)
		{}

		/// Move constructs an exception from \a rhs.
		catapult_error(catapult_error&& rhs) : TStlException(rhs.what()), boost::exception(std::move(rhs))
		{}
	};
