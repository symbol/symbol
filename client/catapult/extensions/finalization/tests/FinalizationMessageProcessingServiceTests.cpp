...
#define TEST_CLASS FinalizationMessageProcessingServiceTests
	...
	TEST(TEST_CLASS, SingleNewMessageIsAddedToAggregatorAndForwarded) {
		...
		auto pMessage = context.createMessage(VoterType::Large1, { 12, 1, 0 }, Height(10), hash);
	...
	TEST(TEST_CLASS, MultipleNewMessagesAreAddedToAggregatorAndForwarded) {
		...
		// - prepare message(s)
		const auto& hash = test::GenerateRandomByteArray<Hash256>();
		auto pMessage1 = context.createMessage(VoterType::Large1, { 12, 1, 0 }, Height(9), hash);
		auto pMessage2 = context.createMessage(VoterType::Large1, { 11, 1, 0 }, Height(8), hash);
		auto pMessage3 = context.createMessage(VoterType::Large1, { 10, 1, 0 }, Height(7), hash);
		auto pMessage4 = context.createMessage(VoterType::Large1, { 9, 1, 0 }, Height(6), hash);
		auto pMessage5 = context.createMessage(VoterType::Large1, { 8, 1, 0 }, Height(5), hash);
	...
	TEST(TEST_CLASS, MessagesWithFinalizationPointsOutOfRangeAreIgnored) {
		...
		// - prepare message(s)
		const auto& hash = test::GenerateRandomByteArray<Hash256>();
		auto pMessage1 = context.createMessage(VoterType::Large1, { 10, 1, 0 }, Height(9), hash);
		auto pMessage2 = context.createMessage(VoterType::Large1, { 9, 1, 0 }, Height(8), hash);
		auto pMessage3 = context.createMessage(VoterType::Large1, { 12, 1, 0 }, Height(9), hash);
		auto pMessage4 = context.createMessage(VoterType::Large1, { 13, 1, 0 }, Height(10), hash);
	...
	TEST(TEST_CLASS, MessageWithHigherFinalizationPointCanBeProcessedAfterLocalFinalizationPointIncreases) {
		...
		// - prepare message(s)
		const auto& hash = test::GenerateRandomByteArray<Hash256>();
		auto pMessage1 = context.createMessage(VoterType::Large1, { 11, 1, 0 }, Height(8), hash);
		auto pMessage2 = context.createMessage(VoterType::Large1, { 12, 1, 0 }, Height(9), hash);
		auto pMessage3 = context.createMessage(VoterType::Large1, { 10, 1, 0 }, Height(7), hash);
		auto pMessage4 = context.createMessage(VoterType::Large1, { 9, 1, 0 }, Height(6), hash);
