...
#define TEST_CLASS UnlockedAccountsStorageTests
    ...
    namespace {
        ...
        auto PrepareEncryptedPayloads(const Key& recipientPublicKey, const std::vector<BlockGeneratorAccountDescriptor>& descriptors)
        {
            ...
            for (const auto& descriptor : descriptors) {
                auto encryptedPayload = test::PrepareHarvestRequestEncryptedPayload(recipientPublicKey, test::ToClearTextBuffer(descriptor));
    ...
    namespace {
        ...
        using BlockGeneratorAccountDescriptorUnorderedSet = std::unordered_set<BlockGeneratorAccountDescriptor, BlockGeneratorAccountDescriptorHasher>;
