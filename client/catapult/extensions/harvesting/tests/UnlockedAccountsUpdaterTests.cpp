...
#define TEST_CLASS UnlockedAccountsUpdaterTests
	...
	namespace {
		...
		class TestContext {
		public:
			enum class SeedOptions { Address,
				Public_Key,
				Remote };
		...
		public:
			...
			void appendHarvesterDirectlyToHarvestersFile(const BlockGeneratorAccountDescriptor& descriptor) {
				...
				auto encryptedPayload = test::PrepareHarvestRequestEncryptedPayload(m_encryptionKeyPair.publicKey(), test::ToClearTextBuffer(descriptor));
