...
namespace harvesting {
    ...
    namespace {
        ...
        enum class SortDirection { Ascending,
            Descending };
        ...
        TransactionsInfo SupplyMaximumFee(const SupplyInput& input)
        {
            ...
            auto candidates = GetFirstTransactionInfoPointers(input, comparer, [&utFacade = input.UtFacade, &maximizer](const auto& transactionInfo) {
