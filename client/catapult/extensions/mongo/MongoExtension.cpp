...
namespace catapult { namespace mongo { namespace {
	...
	void RegisterExtension(extensions::ProcessBootstrapper& bootstrapper) {
		...
		bootstrapper.subscriptionManager().addBlockChangeSubscriber(io::CreateBlockStorageChangeSubscriber(std::move(pMongoBlockStorage)));
		...
		bootstrapper.subscriptionManager().addStateChangeSubscriber(
				std::make_unique<ApiStateChangeSubscriber>(std::move(pChainScoreProvider), std::move(pExternalCacheStorage)));
