...
#define EXPECT_EQ_TRANSACTION_UPDATE_RESULT(RESULT, UPDATE_TYPE, NUM_COSIGNATURES_ADDED)     \
    ...
    namespace {
        ...
        private:
            using ValidateCosignatoriesResultTriggers = std::vector<std::pair<ValidateCosignatoriesResultTrigger, CosignatoriesValidationResult>>;
