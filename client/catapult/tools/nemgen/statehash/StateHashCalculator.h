...
namespace catapult { namespace tools { namespace nemgen {
	...
	/// Information about a block state hash.
	struct BlockStateHashInfo {
		/// Block state hash.
		Hash256 StateHash;
	...
	/// Calculates the state hash after executing nemesis \a blockElement for network configured with \a config.
