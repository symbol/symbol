...
#define TEST_CLASS MetadataValueValidatorTests
	...
	TEST(TEST_CLASS, FailureWhenCacheValueSizeAndExpectedValueSizeDoNotMatch) {
		...
		RunEntryInCacheTest(
				...
				{ { 0, 4 }, { 0xBA, 0xE8, 0xBC, 0x4B, 0x4B }, { 0xBA, 0xE8, 0xBC, 0x4B } });
		// - cache value size = 5; expected value size = 6
		RunEntryInCacheTest(
				Failure_Metadata_Value_Size_Delta_Mismatch,
				{ { 1, 7 }, { 0xE0, 0x77, 0xCC, 0xCC, 0x02 }, { 0xBA, 0xE8, 0xBC, 0x4B, 0x4B, 0xEE, 0x1F } });
		// - cache value size = 5; expected value size = 7
		RunEntryInCacheTest(
				Failure_Metadata_Value_Size_Delta_Mismatch,
				{ { -2, 7 }, { 0xBA, 0xE8, 0xBC, 0x4B, 0x4B }, { 0xE0, 0x77, 0xCC, 0xCC, 0x4B, 0xEE, 0x1F } });
	}

	TEST(TEST_CLASS, SuccessWhenCacheValueSizeIsEqualToNewValueSize) {
		RunEntryInCacheTest(ValidationResult::Success, { { 0, 5 }, { 0xE0, 0x77, 0xCC, 0xCC, 0x02 }, { 0xBA, 0xE8, 0xBC, 0x4B, 0x4B } });
	}

	TEST(TEST_CLASS, SuccessWhenCacheValueSizeIsLessThanNewValueSize) {
		RunEntryInCacheTest(
				ValidationResult::Success,
				{ { 2, 7 }, { 0xE0, 0x77, 0xCC, 0xCC, 0x02 }, { 0xBA, 0xE8, 0xBC, 0x4B, 0x4B, 0xEE, 0x1F } });
	}

	TEST(TEST_CLASS, SuccessWhenCacheValueSizeIsGreaterThanNewValueSizeAndTruncationIsReversible) {
		RunEntryInCacheTest(
				ValidationResult::Success,
				{ { -3, 7 }, { 0xBA, 0xE8, 0xBC, 0x4B, 0x4B, 0xEE, 0x1F }, { 0xE0, 0x77, 0xCC, 0xCC, 0x4B, 0xEE, 0x1F } });
	}
	...
	TEST(TEST_CLASS, FailureWhenCacheValueSizeIsGreaterThanNewValueSizeButTruncationIsNotReversible) {
		RunEntryInCacheTest(
				...
				{ { -3, 7 }, { 0xBA, 0xE8, 0xBC, 0x4B, 0x4B, 0xEE, 0x1F }, { 0xE0, 0x77, 0xCC, 0xCC, 0x4B, 0xEF, 0x1F } });
	}
