...
#undef DEFINE_ACCOUNT_RESTRICTION_NOTIFICATION
	...
	using ModifyAccountAddressRestrictionsNotification = ModifyAccountRestrictionsNotification<UnresolvedAddress, RestrictionAccount_Address_Modifications_Notification>;
	using ModifyAccountMosaicRestrictionsNotification = ModifyAccountRestrictionsNotification<UnresolvedMosaicId, RestrictionAccount_Mosaic_Modifications_Notification>;
	using ModifyAccountOperationRestrictionsNotification = ModifyAccountRestrictionsNotification<EntityType, RestrictionAccount_Operation_Modifications_Notification>;
