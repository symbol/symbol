...
namespace catapult { namespace handlers {
	...
	namespace {
		struct MultisigInfosTraits : public test::CacheEntryInfoHandlerTestTraits<Key, ionet::PacketType::Multisig_Infos> {
		public:
		...
		public:
			...
			static void RegisterHandler(ionet::ServerPacketHandlers& handlers, TAction action) {
				RegisterMultisigInfosHandler(handlers, test::BatchHandlerSupplierActionToProducer<ResponseType>(action));
			}
		};
	}

	DEFINE_BATCH_HANDLER_TESTS(MultisigDiagnosticHandlersTests, MultisigInfos)
}}
