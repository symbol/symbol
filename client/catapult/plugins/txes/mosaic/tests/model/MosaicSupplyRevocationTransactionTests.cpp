...
#define TEST_CLASS MosaicSupplyRevocationTransactionTests

	// region size + alignment + properties

#define TRANSACTION_FIELDS FIELD(SourceAddress) FIELD(Mosaic)
...
#undef FIELD
		...
		void AssertTransactionHasExpectedProperties() {
			// Assert:
			EXPECT_EQ(Entity_Type_Mosaic_Supply_Revocation, T::Entity_Type);
...
#undef TRANSACTION_FIELDS
	...
	ADD_BASIC_TRANSACTION_SIZE_PROPERTY_TESTS(MosaicSupplyRevocation)
	...
	TEST(TEST_CLASS, CanCalculateRealSizeWithReasonableValues) {
		...
		// Act:
		auto realSize = MosaicSupplyRevocationTransaction::CalculateRealSize(transaction);

		// Assert:
		EXPECT_EQ(sizeof(MosaicSupplyRevocationTransaction), realSize);
	}
