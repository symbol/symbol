...
namespace catapult { namespace plugins {
	...
	void RegisterLockSubsystem(PluginManager& manager) {
		...
		manager.addCacheSupport<cache::HashLockInfoCacheStorage>(std::make_unique<cache::HashLockInfoCache>());
		manager.addCacheSupport<cache::SecretLockInfoCacheStorage>(std::make_unique<cache::SecretLockInfoCache>());
