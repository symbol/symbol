...
#define HARVESTER_TEST(TEST_NAME)                                         \
    ...
    TEST(TEST_CLASS, TEST_NAME##_MainHarvester)                           \
    {                                                                     \
        TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<MainHarvesterTraits>();   \
    }                                                                     \
    TEST(TEST_CLASS, TEST_NAME##_RemoteHarvester)                         \
    {                                                                     \
        TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<RemoteHarvesterTraits>(); \
    }                                                                     \
    template <typename TTraits>                                           \
    void TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)()
    ...
    HARVESTER_TEST(ObserverCreditsAccountsOnCommit_Single)
    {
        ...
        std::vector<SeedTuple> expiringSeeds { { address, MosaicId(500), Amount(333), Amount(33) } };
        ...
        ObserverTests::RunBalanceTest(
            ...
            blockHarvesterPublicKey,
            expiringSeeds,
            { { address, MosaicId(500), Amount(333), Amount() }, { blockHarvester, MosaicId(500), Amount(200 + 33), Amount() } });
    }
    ...
    namespace {
        ...
        {
            return { { addresses[0], MosaicId(500), Amount(333), Amount(33) },
    ...
    HARVESTER_TEST(ObserverCreatesReceiptsOnCommit)
    {
        ...
        std::vector<SeedTuple> expiringSeeds { { Address { { 9 } }, MosaicId(500), Amount(333), Amount(33) },
