...
namespace validators {
	...
	DECLARE_STATELESS_VALIDATOR(SecretLockDuration, model::SecretLockDurationNotification)
	(BlockDuration maxSecretLockDuration);
	...
	DECLARE_STATELESS_VALIDATOR(ProofSecret, model::ProofSecretNotification)
	(uint16_t minProofSize, uint16_t maxProofSize);
