#include "src/plugins/MosaicDefinitionTransactionPlugins.h"
...
#define TEST_CLASS MosaicDefinitionTransactionPluginsTests

	// region TransactionPlugin

	namespace {
		DEFINE_TRANSACTION_PLUGIN_WITH_CONFIG_TEST_TRAITS(MosaicDefinition, MosaicRentalFeeConfiguration);
	...
	DEFINE_BASIC_EMBEDDABLE_TRANSACTION_PLUGIN_TESTS(TEST_CLASS, EntityType::Mosaic_Definition, CreateRentalFeeConfiguration(Amount(0)))
