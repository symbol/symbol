...
#include "plugins/txes/restriction_mosaic/src/state/MosaicRestrictionEvaluator.h"
#include "plugins/txes/restriction_mosaic/src/state/MosaicAddressRestriction.h"
