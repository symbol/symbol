#include "src/plugins/TransferTransactionPlugins.h"
...
#define TEST_CLASS TransferTransactionPluginsTests
	...
	DEFINE_BASIC_EMBEDDABLE_TRANSACTION_PLUGIN_TESTS(TEST_CLASS, EntityType::Transfer)
