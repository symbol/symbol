...
namespace catapult { namespace cache {
	...
	public:
		/// Tries to populate \a importance with the importance for \a publicKey at height \a height.
		bool tryGetAccountImportance(const Key& publicKey, Height height, Importance& importance) const;

		/// Gets the importance for \a publicKey at height \a height or a default importance if no importance is set.
