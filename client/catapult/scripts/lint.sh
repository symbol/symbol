...
find . -type f -name "*.py" -print0 | PYTHONPATH=. xargs -0 python3 -m pylint --load-plugins pylint_quotes --disable "consider-using-f-string, unspecified-encoding, consider-using-with"
