...
#define ED25519_DONNA_PORTABLE_H
...
#include "ed25519-donna-basepoint-table.h"
	...
	// #include "ed25519-donna-64bit-x86.h" ==> 14:3: error: inline assembly requires more registers than available
#else
...
#endif // ED25519_DONNA_PORTABLE_H
