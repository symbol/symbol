...
const ownerAddress = Address.fromDecodedAddressHexString(ns.ownerAddress);
console.log('  Owner address:', ownerAddress.toString());
const depth = ns.depth;
console.log('  Depth:', depth);
console.log('  Level 0:', ns.level0);
if (depth >= 2) {
	console.log('  Level 1:', ns.level1);
}
if (depth === 3 && ns.level2) {
	console.log('  Level 2:', ns.level2);
}
console.log('  Start height:', ns.startHeight);
console.log('  End height:', ns.endHeight);
