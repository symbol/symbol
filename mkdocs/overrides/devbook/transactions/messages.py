...
# Configuration
NODE_URL = os.environ.get('NODE_URL', 'https://001-sai-dual.symboltest.net:3001')
...
sender_address = facade.network.public_key_to_address(sender_key_pair.public_key)
...
try:
	...
	if is_decoded:
		print(f'Sender verified encrypted message: {decrypted_message.decode("utf-8")}')
	else:
	...
	# (is_decoded, msg) = recipient_encoder.try_decode(sender_key_pair.public_key, encrypted_payload)
