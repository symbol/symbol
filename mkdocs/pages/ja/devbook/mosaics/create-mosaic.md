...
* モザイクを作成するための [アカウント](default: アカウント) を、[コード](../accounts/create-from-private-key.md) または [ウォレット](../../userbook/desktop-wallet/create-account.md) を使用して作成していること。
...
!!! tip "両方のトランザクションの組み合わせ"
    ...
    定義と供給量変更を2つの別々のトランザクションとしてアナウンスする代わりに、単一の [コンプリートアグリゲートトランザクション](../transactions/complete-aggregate.md) 内でまとめて送信することができます。
