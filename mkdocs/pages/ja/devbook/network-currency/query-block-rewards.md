...
この報酬はその後、[ハーベスタ](default:ハーベスタ)、ノードの受益者（ベネフィシャリー）、およびネットワークのシンクアカウントの間で[分配](../../textbook/harvesting.md#reward-distribution)されます。
...
この値は[絶対単位](default: 分割性)であるため、XYM（分割性 6）の場合、 `113474978` 絶対単位は `113.474978` ユニット単位を表します。
