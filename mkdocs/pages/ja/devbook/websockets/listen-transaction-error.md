...
| ステップ | 関連ドキュメント |
|------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| [status チャネルのサブスクライブ](#status) | <ws:status&#47;{address}> |
| [拒否をトリガーする](#_6) | [転送トランザクション](../transactions/transfer.md) |
| [エラーメッセージの処理](#_7) | [TransactionStatusDTO](../reference/rest/symbol.md#model-TransactionStatusDTO) |