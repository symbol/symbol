...
# 新しいアカウントの作成 {: #creating-a-new-account }

このページでは、Symbol Desktop Wallet の既存の [プロファイル](default:プロファイル) に新しい [アカウント](default:アカウント) を追加する方法を説明します。
...
## 新しいアカウントの作成方法 {: #how-to-create-a-new-account }
...
[プロファイルのエクスポート](./export-profile.md) を行うと、シードアカウントとインポートされたアカウントの両方が1つの [ペーパーウォレット](default:ペーパーウォレット) にバックアップされます。
