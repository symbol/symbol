...
変更できるのは、モザイクの[プロパティ](#properties)（供給量の可変性、転送可能性、制限可能性、取り消し可能性）、
[可分性](#divisibility)、および[有効期間](#duration)です。

総供給量自体はこれとは別で、[供給量の可変性](#supply-mutability)が有効であれば、ミントやバーンによっていつでも調整できます。
