...
トランザクション
:   トランザクションとは、Symbol ブロックチェーン上で実行される 1 つまたは複数のアクションを表します。
...
署名は、各アカウントの[秘密キー](default:秘密キー)の保有者のみが有効な署名を生成できることから、
...
一部のトランザクションタイプでは、追加の意味的検証も必要です。
...
| 属性名           | 説明                                                                   |
| ---------------- | ---------------------------------------------------------------------- |
| **署名者公開キー** | トランザクションを作成・署名したアカウントの[公開キー](default:公開キー)。 |
...
| **検証項目**   | **説明**                                                                                 |
| -------------- | ---------------------------------------------------------------------------------------- |
| **署名検証**   | 署名が有効であり、署名者の公開キーおよびトランザクション内容と一致しているかを確認します。 |
...
| [**ファイナライズ**](#7)                                    |                                                                                                                                        |
| `Voting Key Link`                                                        | ファイナライズ投票に必要な BLS 公開キーをアカウントにリンクします。                                                                      |
...
| `VRF Key Link`                                                           | ハーベスティングに必要な VRF 公開キーをアカウントにリンクします。                                                                        |
| **ロック**                                                               |                                                                                                                                        |
