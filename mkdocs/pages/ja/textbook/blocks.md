...
| `Mosaic Rental Fee`        | モザイク登録時に発生する送信者・受信者・コスト。モザイクを登録したときに記録されます。                                                                       |
| **ネームスペース**         |                                                                                                                                                                        |
...
| `Namespace Rental Fee`     | ネームスペースの登録または更新（レンタル延長）に関連する送信者・受信者・コスト。[ネームスペース](default:ネームスペース)の登録時または更新時に記録されます。             |
| **HashLock**               |                                                                                                                                                                        |
