...
The [User Manual](../userbook/intro.md) and the [Developer Manual](../devbook/intro.md) already provide links
to the appropriate textbook pages when needed, so there is typically no need to read this book cover to cover.
