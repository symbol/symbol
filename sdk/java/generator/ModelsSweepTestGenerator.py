...
from .Generator import _derive_package_name, create_printer, to_type_formatter_instance
...
def generate_files(ast_models, output_directory: Path):
	...
	if 'models' == output_directory.name and output_directory.parent.name in ('nem', 'symbol'):
		write_sweep_test_file(
			output_directory, _derive_package_name(output_directory), header=_HEADER, imports=_SWEEP_TEST_IMPORTS,
