 ...
 *
 * Send transactions in batches to different accounts (V1, deprecated). Use this transaction when all required signatures are available when
 * the transaction is created.
 */
public final class AggregateCompleteTransactionV1Descriptor implements SymbolTransactionDescriptor {
