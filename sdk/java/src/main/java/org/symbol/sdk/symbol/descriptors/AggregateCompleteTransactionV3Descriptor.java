 ...
 *
 * Send transactions in batches to different accounts (V3, latest). Use this transaction when all required signatures are available when the
 * transaction is created.
 */
public final class AggregateCompleteTransactionV3Descriptor implements SymbolTransactionDescriptor {
