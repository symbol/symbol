...
public final class SymbolTransactionFactory {
	...
	public static EmbeddedTransaction deserializeEmbedded(final byte[] payload) {
		return deserializeEmbedded(java.nio.ByteBuffer.wrap(payload));
	}
	 ...
	 * @return Deserialized embedded transaction.
	 */
	public static EmbeddedTransaction deserializeEmbedded(final java.nio.ByteBuffer buffer) {
		return EmbeddedTransactionFactory.deserialize(buffer);
	}
