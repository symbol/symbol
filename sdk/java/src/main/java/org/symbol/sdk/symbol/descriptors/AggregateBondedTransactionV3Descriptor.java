 ...
 *
 * Propose an arrangement of transactions between different accounts (V3, latest). Use this transaction when not all required signatures are
 * available when the transaction is created. Missing signatures must be provided using a Cosignature or DetachedCosignature. To prevent
 ...
 */
public final class AggregateBondedTransactionV3Descriptor implements SymbolTransactionDescriptor {
