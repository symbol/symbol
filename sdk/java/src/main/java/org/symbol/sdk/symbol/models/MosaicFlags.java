...
public final class MosaicFlags implements Serializer {
	 ...
	 */
	public static MosaicFlags deserialize(final BufferView view) {
	 ...
	 * @throws IllegalArgumentException if a field carries an invalid value (e.g. a reserved field or unknown discriminator)
	 */
	public static MosaicFlags deserialize(final byte[] payload) {
	...
	public String toString() {
		final MosaicFlags[] candidates = {
				MosaicFlags.NONE, MosaicFlags.SUPPLY_MUTABLE, MosaicFlags.TRANSFERABLE, MosaicFlags.RESTRICTABLE, MosaicFlags.REVOKABLE
		};
		final String[] names = {
