...
class MetadataTest(unittest.TestCase):
	...
	def test_can_update_equal_length_value(self):
		...
		# Assert:
		self.assertEqual([0x9A ^ 0xD4, 0xC7 ^ 0x60, 0x33 ^ 0x82, 0x18 ^ 0xF8, 0xA7 ^ 0x78, 0xB0 ^ 0xFE, 0x36 ^ 0x78], result)
	...
	def test_can_update_shorter_value(self):
		...
		# Assert:
		self.assertEqual([0x9A ^ 0xD4, 0xC7 ^ 0x60, 0x33 ^ 0x82, 0x18 ^ 0xF8], result)
