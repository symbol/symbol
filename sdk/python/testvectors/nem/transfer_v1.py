...
recipes = {
	...
	'descriptors': [
		# comment: v1, plain, non-empty message, single mosaic
		{
		...
		# comment: v1, encrypted, non-empty message, single mosaic
		{
			'type': 'transfer_transaction_v1',
			'recipient_address': 'TACQ6J4XXABJ4FRQ63ZHQ7PGDDTZCBJYK4ANOE36',
			'amount': 0x00000000004C4B40,
		...
		# comment: v1, plain, non-empty message, multiple mosaics
		{
			'type': 'transfer_transaction_v1',
			'recipient_address': 'TACQ6J4XXABJ4FRQ63ZHQ7PGDDTZCBJYK4ANOE36',
			'amount': 0x00000000004C4B40,
