recipes = {
	...
	'descriptors': [
		# comment: v1, no-op, increase min-approval
		{
			'type': 'multisig_account_modification_transaction_v1',
			'modifications': [],
			'min_approval_delta': 0x2
		},
		# comment: v1, add, decrease min-approval
		{
			'type': 'multisig_account_modification_transaction_v1',
			'modifications': [
				{
		...
		# comment: v1, add, add, del, increase min-approval
		{
			'type': 'multisig_account_modification_transaction_v1',
			'modifications': [
				{
		...
		# comment: v1, add, add, del, increase min-approval (out of order)
