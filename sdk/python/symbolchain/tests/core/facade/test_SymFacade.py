...
class SymFacadeTest(unittest.TestCase):
    ...
    def test_hasher_is_correct(self):
        ...
        # Act:
        hash_value = SymFacade.Hasher(unhexlify(message)).digest()

        # Assert:
        self.assertEqual(unhexlify('85FEF4EEC0B798E6F4CF29EB5B8D3F3096885EB88865DD62D5D0BD63ADE67384'), hash_value)
