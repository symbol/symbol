...
class MultisigTransactionV2:
	...
	def __init__(self):
		self._type_ = MultisigTransactionV2.TRANSACTION_TYPE
		self._version = MultisigTransactionV2.TRANSACTION_VERSION
		self._network = NetworkType.MAINNET
		self._timestamp = Timestamp()
		self._signer_public_key = PublicKey()
		self._signature = Signature()
	...
	@classmethod
	def deserialize(cls, payload: ByteString) -> MultisigTransactionV2:
		buffer = memoryview(payload)
		type_ = TransactionType.deserialize(buffer)
		buffer = buffer[type_.size:]
		version = int.from_bytes(buffer[:1], byteorder='little', signed=False)
		...
		instance = MultisigTransactionV2()
		instance._type_ = type_
		instance._version = version
		instance._network = network
		instance._timestamp = timestamp
...
class NonVerifiableMultisigTransactionV2:
	TRANSACTION_VERSION: int = 2
	TRANSACTION_TYPE: TransactionType = TransactionType.MULTISIG_TRANSACTION
	TYPE_HINTS = {
		'type_': 'enum:TransactionType',
	...
	def __init__(self):
		self._type_ = NonVerifiableMultisigTransactionV2.TRANSACTION_TYPE
		self._version = NonVerifiableMultisigTransactionV2.TRANSACTION_VERSION
		self._network = NetworkType.MAINNET
		self._timestamp = Timestamp()
		self._signer_public_key = PublicKey()
		self._fee = Amount()
	...
	@classmethod
	def deserialize(cls, payload: ByteString) -> NonVerifiableMultisigTransactionV2:
		buffer = memoryview(payload)
		type_ = TransactionType.deserialize(buffer)
		buffer = buffer[type_.size:]
		version = int.from_bytes(buffer[:1], byteorder='little', signed=False)
		...
		instance = NonVerifiableMultisigTransactionV2()
		instance._type_ = type_
		instance._version = version
		instance._network = network
		instance._timestamp = timestamp
...
class TransactionFactory:
	...
	def deserialize(cls, payload: bytes) -> Transaction:
		...
		mapping = {
			...
			(MultisigTransactionV2.TRANSACTION_TYPE, MultisigTransactionV2.TRANSACTION_VERSION): MultisigTransactionV2,
...
class NonVerifiableTransactionFactory:
	...
	def deserialize(cls, payload: bytes) -> NonVerifiableTransaction:
		...
		mapping = {
			...
			(NonVerifiableMultisigTransactionV2.TRANSACTION_TYPE, NonVerifiableMultisigTransactionV2.TRANSACTION_VERSION): NonVerifiableMultisigTransactionV2,
