...
| ------ | ------ | ------ |
| `path` | [`PatriciaTreePath`](PatriciaTreePath.md) | Branch path. |
| `links` | [`Hash256`](../../index/Hash256.md)[] | Branch links. |
...
| ------ | ------ | ------ | ------ |
| <a id="links"></a> `links` | [`Hash256`](../../index/Hash256.md)[] | Branch links. | - |
| <a id="path"></a> `path` | [`PatriciaTreePath`](PatriciaTreePath.md) | Node path. | [`TreeNode`](TreeNode.md).[`path`](TreeNode.md#path) |
