...
| ------ | ------ | ------ |
| `targetAddress` | [`Address`](../Address.md) | Account owning the mosaic whose metadata should be modified. |
| `scopedMetadataKey` | `bigint` | Metadata key scoped to source, target and type. |
| `targetMosaicId` | [`UnresolvedMosaicId`](../models/UnresolvedMosaicId.md) | Mosaic whose metadata should be modified. |
...
| `rawDescriptor.targetAddress` | [`Address`](../Address.md) |
| `rawDescriptor.targetMosaicId` | [`UnresolvedMosaicId`](../models/UnresolvedMosaicId.md) |
