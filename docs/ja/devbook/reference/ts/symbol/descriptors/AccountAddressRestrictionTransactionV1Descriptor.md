...
| ------ | ------ | ------ |
| `restrictionFlags` | [`AccountRestrictionFlags`](../models/AccountRestrictionFlags.md) | Type of restriction being applied to the listed addresses. |
| `restrictionAdditions?` | [`Address`](../Address.md)[] | Array of account addresses being added to the restricted list. |
| `restrictionDeletions?` | [`Address`](../Address.md)[] | Array of account addresses being removed from the restricted list. |
