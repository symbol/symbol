...
| ------ | ------ | ------ |
| `mosaicId` | [`UnresolvedMosaicId`](../models/UnresolvedMosaicId.md) | Identifier of the mosaic to which the restriction applies. |
...
| `targetAddress` | [`Address`](../Address.md) | Address being restricted. |
