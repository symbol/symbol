...
| `duration` | [`BlockDuration`](../models/BlockDuration.md) | Number of blocks for which a lock should be valid. The default maximum is 48h (See the `maxHashLockDuration` network property). |
| `hash` | [`Hash256`](../../index/Hash256.md) | Hash of the AggregateBondedTransaction to be confirmed before unlocking the mosaics. |
...
| `rawDescriptor.hash` | [`Hash256`](../../index/Hash256.md) |
