# Class: AggregateBondedTransactionV3
...
### new AggregateBondedTransactionV3()

```ts
new AggregateBondedTransactionV3(): AggregateBondedTransactionV3
```
...
```ts
static deserialize(payload): AggregateBondedTransactionV3
```
