...
### new MosaicGlobalRestrictionTransactionV1()

```ts
new MosaicGlobalRestrictionTransactionV1(): MosaicGlobalRestrictionTransactionV1
```
...
```ts
static deserialize(payload): MosaicGlobalRestrictionTransactionV1
```
