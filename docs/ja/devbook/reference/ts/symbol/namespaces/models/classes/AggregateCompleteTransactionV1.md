...
### new AggregateCompleteTransactionV1()

```ts
new AggregateCompleteTransactionV1(): AggregateCompleteTransactionV1
```
...
```ts
static deserialize(payload): AggregateCompleteTransactionV1
```
