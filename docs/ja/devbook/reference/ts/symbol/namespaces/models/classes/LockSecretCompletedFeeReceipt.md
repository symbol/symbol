...
### new LockSecretCompletedFeeReceipt()

```ts
new LockSecretCompletedFeeReceipt(): LockSecretCompletedFeeReceipt
```
...
```ts
static deserialize(payload): LockSecretCompletedFeeReceipt
```
...
```ts
static deserializeAligned(payload): LockSecretCompletedFeeReceipt
```
