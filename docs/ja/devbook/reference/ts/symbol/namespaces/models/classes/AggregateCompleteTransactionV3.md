# Class: AggregateCompleteTransactionV3
...
### new AggregateCompleteTransactionV3()

```ts
new AggregateCompleteTransactionV3(): AggregateCompleteTransactionV3
```
...
```ts
static deserialize(payload): AggregateCompleteTransactionV3
```
