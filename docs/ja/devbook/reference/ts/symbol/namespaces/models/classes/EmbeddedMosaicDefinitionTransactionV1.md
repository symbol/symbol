...
```ts
new EmbeddedMosaicDefinitionTransactionV1(): EmbeddedMosaicDefinitionTransactionV1
```
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="_divisibility"></a> `_divisibility` | `public` | `number` | - | - |
...
| <a id="_flags"></a> `_flags` | `public` | [`MosaicFlags`](MosaicFlags.md) | - | - |
...
| <a id="_nonce"></a> `_nonce` | `public` | [`MosaicNonce`](MosaicNonce.md) | - | - |
...
| `TYPE_HINTS.flags` | `public` | `string` | - | - |
| `TYPE_HINTS.id` | `public` | `string` | - | - |
| `TYPE_HINTS.network` | `public` | `string` | - | - |
| `TYPE_HINTS.nonce` | `public` | `string` | - | - |
...
| Parameter | Type |
| ------ | ------ |
| `value` | [`MosaicFlags`](MosaicFlags.md) |
...
| Parameter | Type |
| ------ | ------ |
| `value` | [`MosaicNonce`](MosaicNonce.md) |
...
```ts
static deserialize(payload): EmbeddedMosaicDefinitionTransactionV1
```
