...
```ts
new EmbeddedMosaicSupplyRevocationTransactionV1(): EmbeddedMosaicSupplyRevocationTransactionV1
```
...
```ts
static deserialize(payload): EmbeddedMosaicSupplyRevocationTransactionV1
```
