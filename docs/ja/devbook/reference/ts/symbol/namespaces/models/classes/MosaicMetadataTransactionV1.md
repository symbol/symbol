...
### new MosaicMetadataTransactionV1()

```ts
new MosaicMetadataTransactionV1(): MosaicMetadataTransactionV1
```
...
| <a id="_targetmosaicid"></a> `_targetMosaicId` | `public` | [`UnresolvedMosaicId`](UnresolvedMosaicId.md) | - | - |
...
| `TYPE_HINTS.targetMosaicId` | `public` | `string` | - | - |
...
```ts
static deserialize(payload): MosaicMetadataTransactionV1
```
