...
### new NamespaceDeletedReceipt()

```ts
new NamespaceDeletedReceipt(): NamespaceDeletedReceipt
```
...
```ts
static deserialize(payload): NamespaceDeletedReceipt
```
...
```ts
static deserializeAligned(payload): NamespaceDeletedReceipt
```
