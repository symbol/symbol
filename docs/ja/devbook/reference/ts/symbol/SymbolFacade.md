...
| <a id="derivesharedkey"></a> `deriveSharedKey` | `static` | (`keyPair`, `otherPublicKey`) => [`SharedKey256`](../index/SharedKey256.md) | Derives shared key from key pair and other party's public key. |
...
| `transaction` | [`Transaction`](models/Transaction.md) | Transaction object. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `privateKey` | [`PrivateKey`](../index/PrivateKey.md) | Account private key. |
...
| `signerPublicKey` | [`PublicKey`](../index/PublicKey.md) | Signer public key. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `publicKey` | [`PublicKey`](../index/PublicKey.md) | Account public key. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `bip32Node` | [`Bip32Node`](../Bip32/Bip32Node.md) | BIP32 node. |
...
| ------ | ------ | ------ |
| `keyPair` | [`KeyPair`](KeyPair.md) | Key pair of the cosignatory. |
| `transactionHash` | [`Hash256`](../index/Hash256.md) | Transaction hash. |
| `detached?` | `boolean` | \c true if resulting cosignature is appropriate for network propagation. \c false if resulting cosignature is appropriate for attaching to an aggregate. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `embeddedTransactions` | [`EmbeddedTransaction`](models/EmbeddedTransaction.md)[] | Embedded transactions to hash. |
