...
### new MosaicExpiredReceipt()

```ts
new MosaicExpiredReceipt(): MosaicExpiredReceipt
```
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="_artifactid"></a> `_artifactId` | `public` | [`MosaicId`](MosaicId.md) | - | - |
...
```ts
static deserialize(payload): MosaicExpiredReceipt
```
...
```ts
static deserializeAligned(payload): MosaicExpiredReceipt
```
