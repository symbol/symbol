...
| <a id="child"></a> `CHILD` | `static` | [`NamespaceRegistrationType`](NamespaceRegistrationType.md) |
| <a id="root"></a> `ROOT` | `static` | [`NamespaceRegistrationType`](NamespaceRegistrationType.md) |
