...
### new LockHashExpiredFeeReceipt()

```ts
new LockHashExpiredFeeReceipt(): LockHashExpiredFeeReceipt
```
...
```ts
static deserialize(payload): LockHashExpiredFeeReceipt
```
...
```ts
static deserializeAligned(payload): LockHashExpiredFeeReceipt
```
