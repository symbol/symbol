...
### new AccountAddressRestrictionTransactionV1()

```ts
new AccountAddressRestrictionTransactionV1(): AccountAddressRestrictionTransactionV1
```
...
```ts
static deserialize(payload): AccountAddressRestrictionTransactionV1
```
