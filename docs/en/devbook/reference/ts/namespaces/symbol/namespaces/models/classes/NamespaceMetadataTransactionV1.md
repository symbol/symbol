...
### new NamespaceMetadataTransactionV1()

```ts
new NamespaceMetadataTransactionV1(): NamespaceMetadataTransactionV1
```
...
| <a id="_targetnamespaceid"></a> `_targetNamespaceId` | `public` | [`NamespaceId`](NamespaceId.md) | - | - |
...
| `TYPE_HINTS.targetNamespaceId` | `public` | `string` | - | - |
...
```ts
set targetNamespaceId(value): void
```
...
```ts
static deserialize(payload): NamespaceMetadataTransactionV1
```
