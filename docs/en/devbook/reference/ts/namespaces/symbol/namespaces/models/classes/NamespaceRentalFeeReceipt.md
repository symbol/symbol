...
### new NamespaceRentalFeeReceipt()

```ts
new NamespaceRentalFeeReceipt(): NamespaceRentalFeeReceipt
```
...
```ts
static deserialize(payload): NamespaceRentalFeeReceipt
```
...
```ts
static deserializeAligned(payload): NamespaceRentalFeeReceipt
```
