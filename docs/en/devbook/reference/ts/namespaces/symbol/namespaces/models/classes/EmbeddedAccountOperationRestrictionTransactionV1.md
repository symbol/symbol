...
```ts
new EmbeddedAccountOperationRestrictionTransactionV1(): EmbeddedAccountOperationRestrictionTransactionV1
```
...
```ts
static deserialize(payload): EmbeddedAccountOperationRestrictionTransactionV1
```
