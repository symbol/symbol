...
### new AccountOperationRestrictionTransactionV1()

```ts
new AccountOperationRestrictionTransactionV1(): AccountOperationRestrictionTransactionV1
```
...
```ts
static deserialize(payload): AccountOperationRestrictionTransactionV1
```
