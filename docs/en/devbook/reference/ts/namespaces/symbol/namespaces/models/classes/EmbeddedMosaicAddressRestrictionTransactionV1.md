...
```ts
new EmbeddedMosaicAddressRestrictionTransactionV1(): EmbeddedMosaicAddressRestrictionTransactionV1
```
...
```ts
static deserialize(payload): EmbeddedMosaicAddressRestrictionTransactionV1
```
