...
### new LockHashCompletedFeeReceipt()

```ts
new LockHashCompletedFeeReceipt(): LockHashCompletedFeeReceipt
```
...
```ts
static deserialize(payload): LockHashCompletedFeeReceipt
```
...
```ts
static deserializeAligned(payload): LockHashCompletedFeeReceipt
```
