...
| ------ | ------ | ------ |
| `recipientAddress` | [`Address`](../Address.md) | Address that receives the funds once successfully unlocked by a SecretProofTransaction. |
| `secret` | [`Hash256`](../../index/Hash256.md) | Hashed proof. |
| `mosaic` | [`UnresolvedMosaicDescriptor`](UnresolvedMosaicDescriptor.md) | Locked mosaics. |
| `duration` | [`BlockDuration`](../models/BlockDuration.md) | Number of blocks to wait for the SecretProofTransaction. |
| `hashAlgorithm` | [`LockHashAlgorithm`](../models/LockHashAlgorithm.md) | Algorithm used to hash the proof. |
...
| `rawDescriptor.hashAlgorithm` | [`LockHashAlgorithm`](../models/LockHashAlgorithm.md) |
| `rawDescriptor.mosaic` | `any` |
| `rawDescriptor.recipientAddress` | [`Address`](../Address.md) |
| `rawDescriptor.secret` | [`Hash256`](../../index/Hash256.md) |
