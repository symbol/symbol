...
| ------ | ------ | ------ |
| `namespaceId` | [`NamespaceId`](../models/NamespaceId.md) | Identifier of the namespace that will become (or stop being) an alias for the address. |
| `address` | [`Address`](../Address.md) | Aliased address. |
| `aliasAction` | [`AliasAction`](../models/AliasAction.md) | Alias action. |
...
| `rawDescriptor.address` | [`Address`](../Address.md) |
| `rawDescriptor.aliasAction` | [`AliasAction`](../models/AliasAction.md) |
| `rawDescriptor.namespaceId` | [`NamespaceId`](../models/NamespaceId.md) |
