...
| ------ | ------ | ------ |
| `restrictionFlags` | [`AccountRestrictionFlags`](../models/AccountRestrictionFlags.md) | Type of restriction being applied to the listed mosaics. |
| `restrictionAdditions?` | [`UnresolvedMosaicId`](../models/UnresolvedMosaicId.md)[] | Array of mosaics being added to the restricted list. |
| `restrictionDeletions?` | [`UnresolvedMosaicId`](../models/UnresolvedMosaicId.md)[] | Array of mosaics being removed from the restricted list. |
