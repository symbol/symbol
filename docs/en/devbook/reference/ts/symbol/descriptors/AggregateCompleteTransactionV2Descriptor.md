...
| ------ | ------ | ------ |
| `transactionsHash` | [`Hash256`](../../index/Hash256.md) | Hash of the aggregate's transaction. |
| `transactions?` | [`EmbeddedTransaction`](../models/EmbeddedTransaction.md)[] | Embedded transaction data. Transactions are variable-sized and the total payload size is in bytes. Embedded transactions cannot be aggregates. |
| `cosignatures?` | [`Cosignature`](../models/Cosignature.md)[] | Cosignatures data. Fills up remaining body space after transactions. |
...
| `rawDescriptor.transactionsHash` | [`Hash256`](../../index/Hash256.md) |
