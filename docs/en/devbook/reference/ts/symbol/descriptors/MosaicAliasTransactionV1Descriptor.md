...
| ------ | ------ | ------ |
| `namespaceId` | [`NamespaceId`](../models/NamespaceId.md) | Identifier of the namespace that will become (or stop being) an alias for the Mosaic. |
| `mosaicId` | [`MosaicId`](../models/MosaicId.md) | Aliased mosaic identifier. |
