...
| ------ | ------ | ------ |
| `linkedPublicKey` | [`PublicKey`](../../index/PublicKey.md) | Linked voting public key. |
| `startEpoch` | [`FinalizationEpoch`](../models/FinalizationEpoch.md) | Starting finalization epoch. |
| `endEpoch` | [`FinalizationEpoch`](../models/FinalizationEpoch.md) | Ending finalization epoch. |
...
| `rawDescriptor.endEpoch` | [`FinalizationEpoch`](../models/FinalizationEpoch.md) |
| `rawDescriptor.linkAction` | [`LinkAction`](../models/LinkAction.md) |
| `rawDescriptor.linkedPublicKey` | [`PublicKey`](../../index/PublicKey.md) |
| `rawDescriptor.startEpoch` | [`FinalizationEpoch`](../models/FinalizationEpoch.md) |
