...
### new SecretProofTransactionV1()

```ts
new SecretProofTransactionV1(): SecretProofTransactionV1
```
...
| <a id="_proof"></a> `_proof` | `public` | `Uint8Array`&lt;`ArrayBuffer`&gt; | - | - |
...
| `TYPE_HINTS.proof` | `public` | `string` | - | - |
...
```ts
static deserialize(payload): SecretProofTransactionV1
```
