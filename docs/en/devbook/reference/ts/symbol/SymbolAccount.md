...
| <a id="publickey"></a> `publicKey` | `public` | [`PublicKey`](../index/PublicKey.md) | Account public key. | [`SymbolPublicAccount`](SymbolPublicAccount.md).[`publicKey`](SymbolPublicAccount.md#publickey) |
